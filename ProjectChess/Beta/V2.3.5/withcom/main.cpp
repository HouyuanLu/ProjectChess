                                ...
                                if (rectmp1 == 1) {
                                    if (xx >= 1 && yy >= 1 && xx <= CB && yy <= CB) {
                                        ...
                                        if (xx <= CB && yy <= CB && xx >= 1 && yy >= 1) {
                                            ...
                                            if (vis[xx][yy] == 0) {
                                                if (cnt >= MIN_LENGTH) {
                                                    cout << "+Couldvis found at: " << xx << yy << endl;
                                                    cout << "ROWTMP: " << rowtmp <<"  VisWay: " << visway << endl;
                                                    couldVis[xx][yy] = true;
                                                    break;
                                                }
                                            }
        ...
        if (rectmp == 1) {
            ...
            while (true) {
                if (x1 >= 1 && y1 >= 1 && x1 <= CB && y1 <= CB) {
                    if (x1 > 0 && y1 > 0 && x1 <= CB && y1 <= CB && vis[x1][y1] == 2) {
                        ...
                        while (true) {
                            if (x11 >= 1 && y11 >= 1 && x11 <= CB && y11 <= CB) {
                                ...
                                if (x11 > 0 && y11 > 0 && x11 <= CB && y11 <= CB && vis[x11][y11] == 0) {
                                    cout << "checktmp >= 1 <= 3 ret 1 SUC 1 BACK" << endl;
                                    vis[x11][y11] = 1;
                                    map[x11][y11] = "1";
                                    usedx = x11;
                                    usedy = y11;
                    ...
                    if (x1 > 0 && y1 > 0 && x1 <= CB && y1 <= CB && vis[x1][y1] == 0) {
                        cout << "checktmp >= 1 <= 3 ret 1 SUC 1 Front" << endl;
                        vis[x1][y1] = 1;
                        map[x1][y1] = "1";
                        usedx = x1;
                        usedy = y1;
        ...
        if (rectmp == -1) {
            ...
            while (true) {
                if (x1 <= CB && y1 <= CB && x1 >= 1 && y1 >= 1) {
                    if (x1 > 0 && y1 > 0 && x1 <= CB && y1 <= CB && vis[x1][y1] == 2) {
                        ...
                        while (true) {
                            if (x11 >= 1 && y11 >= 1 && x11 <= CB && y11 <= CB) {
                                ...
                                if (x11 > 0 && y11 > 0 && x11 <= CB && y11 <= CB && vis[x11][y11] == 0) {
                                    cout << "checktmp >= 1 <= 3 ret 1 SUC 2 BACK" << endl;
                                    vis[x11][y11] = 1;
                                    map[x11][y11] = "1";
                                    usedx = x11;
                                    usedy = y11;
                    ...
                    if (x1 > 0 && y1 > 0 && x1 <= CB && y1 <= CB && vis[x1][y1] == 0) {
                        cout << "checktmp >= 1 <= 3 ret 1 SUC 2 Front" << endl;
                        vis[x1][y1] = 1;
                        map[x1][y1] = "1";
                        usedx = x1;
                        usedy = y1;
            ...
            for (int i = 1; i <= CB; i++) {
                for (int j = 1; j <= CB; j++) {
                    if (couldVis[i][j]) {
                        ...
                        cout << "checktmp >=1<=3 MIN3 COULDVIS SUC" << endl;
                        map[i][j] = "1";
                        vis[i][j] = 1;
                        usedx = i;
                        usedy = j;
            ...
            for (int i = 1; i <= CB; i++) {
                for (int j = 1; j <= CB; j++) {
                    if (couldVis1[i][j]) {
                        ...
                        cout << "checktmp >=1<=3 MIN2 COULDVIS SUC" << endl;
                        map[i][j] = "1";
                        vis[i][j] = 1;
                        usedx = i;
                        usedy = j;
                ...
                while (true) {
                    if (xx > 0 && yy > 0 && xx <= CB && yy <= CB) {
                        if (xx > 0 && yy > 0 && xx <= CB && yy <= CB && vis[xx][yy] == 0) {
                            cout << "Checkwaytmp rect 1 Front" << endl;
                            vis[xx][yy] = 1;
                            map[xx][yy] = "1";
                            usedx = xx;
                            usedy = yy;
                        ...
                        if (xx > 0 && yy > 0 && xx <= CB && yy <= CB && vis[xx][yy] == 2) {
                            ...
                            while (true) {
                                if (x11 >= 1 && y11 >= 1 && x11 <= CB && y11 <= CB) {
                                    ...
                                    if (x11 > 0 && y11 > 0 && x11 <= CB && y11 <= CB && vis[x11][y11] == 0) {
                                        cout << "Checkwaytmp rect 1 BACK" << endl;
                                        vis[x11][y11] = 1;
                                        map[x11][y11] = "1";
                                        usedx = x11;
                                        usedy = y11;
    ...
    for (int i = 1; i <= CB; i++) {
        for (int j = 1; j <= CB; j++) {
            if (couldVis[i][j]) {
                ...
                cout << "MAIN CHECKVIS MIN 3 SUC" << endl;
                map[i][j] = "1";
                vis[i][j] = 1;
                usedx = i;
                usedy = j;
