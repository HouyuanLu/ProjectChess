...
//todo: SUGGEST: Add from 3 (middle) and 2 (down) and 1(somewhere):CHECKVIS/ADD (MAX)/ERROR
    ...
    for (int i = 1; i < 6; i++) {
        if (x1 >= 1 && y1 >= 1 && x1 <= 20 && y1 <= 20) {
            ...
            if (x1 > 0 && y1 > 0 && x1 <= 20 && y1 <= 20 && vis[x1][y1] == 0) {
                if (tmpans >= 3) {
                    cout << "Found couldvis/checktmp/++" << endl;
                    couldVis[x1][y1] = true;
                    int xxx = x1, yyy = y1;
                    for (int j = 1; j < 6; j++) {
                        if (xxx >= 1 && yyy >= 1 && xxx <= 20 && yyy <= 20) {
                            ...
                            if (vis[xxx][yyy] == 0) {
                                cout << "Found couldVis/checkway/++1" << endl;
                ...
                if (tmpans >= 3) {
                    ...
                    for (int j = 1; j < 6; j++) {
                        if (xxx >= 1 && yyy >= 1 && xxx <= 20 && yyy <= 20) {
                            ...
                            if (vis[xxx][yyy] == 0) {
                                cout << "Found couldvis/check/++1"<<endl;
                                couldVis[xxx][yyy] = true;
                                break;
                            }
                        }
