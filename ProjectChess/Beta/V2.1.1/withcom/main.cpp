...
void defend(int x, int y, int MIN_LENGTH){
    ...
    cout << "cur m and dway: " << m << " " << dway << endl;
    if(m == 4){
    ...
    if (rectmp2 == 1) {
        ...
        int yy = y + dy[dway];
        cnt++;
        cout << "rect2 1/1 cnt added" << endl;
        cout << "cur pos " << xx << " " << yy << endl;
        while (true) {
            if (xx > 0 && yy > 0 && xx <= 20 && yy <= 20) {
                if (xx > 0 && yy > 0 && xx <= 20 && yy <= 20 && vis[xx][yy] == 0) {
                    if(cnt >= MIN_LENGTH){
                ...
                if (xx > 0 && yy > 0 && xx <= 20 && yy <= 20 && vis[xx][yy] == 1) {
                    ...
                    cnt1++;
                    cout << "rect2 1/-1 cnt added" << endl;
                    cout << "cur pos " << x11 << " " << y11 << endl;
                    while (true) {
                        if (x11 >= 1 && y11 >= 1 && x11 <= 20 && y11 <= 20) {
                            if (x11 > 0 && y11 > 0 && x11 <= 20 && y11 <= 20 && vis[x11][y11] == 1) {
                                cout << "Rectmp2 1/-1" << endl;
                                cout << "Found 1" << endl;
                                break;
                            }
                            if (x11 > 0 && y11 > 0 && x11 <= 20 && y11 <= 20 && vis[x11][y11] == 2) {
                ...
                yy = yy + dy[dway];
                if(vis[xx][yy] == 2){
                    cout << "rectmp 1/1 cnt added" << endl;
                    cout << "cur pos: " << xx << " " << yy << endl;
                    cnt++;
                }else{
                    cout << "NOT CORRECT HERE!!!" << endl;
                }
            } else {
                break;
            }
...
int main() {
    //h81ND
    cout << "This is Beta V.2.1.1" << endl;
    for (int i = 1; i <= 20; i++) {
        for (int j = 1; j <= 20; j++) {
            map[i][j] = ".";
        }
