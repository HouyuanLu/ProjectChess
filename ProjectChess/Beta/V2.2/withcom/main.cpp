    ...
    for (int i = 1; i < 6; i++) {
        if (x1 >= 1 && y1 >= 1 && x1 <= 20 && y1 <= 20) {
            ...
            if (x1 > 0 && y1 > 0 && x1 <= 20 && y1 <= 20 && vis[x1][y1] == 0) {
                if (tmpans >= 3) {
                    couldVis[x1][y1] = true;
                    cout << "CW1+ Found cv at: " << x1 << " " << y1 << endl;
                    int xxx = x1, yyy = y1;
                    for (int j = 1; j < 6; j++) {
                        if (xxx >= 1 && yyy >= 1 && xxx <= 20 && yyy <= 20) {
                            ...
                            if (vis[xxx][yyy] == 0) {
                                ...
                                cout << "CW2+ Found cv at: " << xxx << " " << yyy << endl;
                                break;
                            }
                        }
                    }
        ...
        if (x11 >= 1 && y11 >= 1 && x11 <= 20 && y11 <= 20) {
            ...
            if (x11 > 0 && y11 > 0 && x11 <= 20 && y11 <= 20 && vis[x11][y11] == 0) {
                if (tmpans >= 3) {
                    ...
                    cout << "CW1- Found cv at: " << x11 << " " << y11 << endl;
                    int xxx = x11, yyy = y11;
                    for (int j = 1; j < 6; j++) {
                        if (xxx >= 1 && yyy >= 1 && xxx <= 20 && yyy <= 20) {
                            xxx += dx[way];
    ...
    for (int i = 1; i < 6; i++) {
        if (x1 >= 1 && y1 >= 1 && x1 <= 20 && y1 <= 20) {
            ...
            if (x1 > 0 && y1 > 0 && x1 <= 20 && y1 <= 20 && vis[x1][y1] == 0) {
                if (tmpans >= 3) {
                    couldVis[x1][y1] = true;
                    cout << "Cai1+ Found cv at: " << x1 << " " << y1 << endl;
                    int xxx = x1, yyy = y1;
                    for (int j = 1; j < 6; j++) {
                        if (xxx >= 1 && yyy >= 1 && xxx <= 20 && yyy <= 20) {
                            xxx -= dx[tmpi];
                            ...
                            if (vis[xxx][yyy] == 0) {
                                couldVis[xxx][yyy] = true;
                                cout << "CAi2+ Found cv at: " << xxx << " " << yyy << endl;
                                break;
                            }
                        }
                    }
    ...
    for (int i = 1; i < 6; i++) {
        if (x11 > 0 && y11 > 0 && x11 <= 20 && y11 <= 20 && vis[x11][y11] == 0) {
            ...
            if (x11 > 0 && y11 > 0 && x11 <= 20 && y11 <= 20 && vis[x11][y11] == 0) {
                if (tmpans >= 3) {
                    couldVis[x11][y11] = true;
                    cout << "CAi1- Found cv at: " << x11 << " " << y11 << endl;
                    int xxx = x11, yyy = y11;
                    for (int j = 1; j < 6; j++) {
                        if (xxx >= 1 && yyy >= 1 && xxx <= 20 && yyy <= 20) {
                            xxx += dx[tmpi];
                                    ...
                                    if (xx >= 1 && yy >= 1 && xx <= 20 && yy <= 20) {
                                        ...
                                        if (xx <= 20 && yy <= 20 && xx >= 1 && yy >= 1) {
                                            ...
                                            if (vis[xx][yy] == 0) {
                                                if (cnt >= MIN_LENGTH) {
                                                    couldVis[xx][yy] = true;
                                                    cout << "cv3+ Found cv at: " << xx << " " << yy << endl;
                                                    break;
                                                }
                                            }
                                        } else {
                                        ...
                                        if (xx <= 20 && yy <= 20 && xx >= 1 && yy >= 1) {
                                            ...
                                            if (vis[xx][yy] == 0) {
                                                if (cnt >= MIN_LENGTH) {
                                                    ...
                                                    cout << "cv2+ Found cv at: " << xx << " " << yy << endl;
                                                    break;
                                                }
                                            }
                                        } else {
                                ...
                                if (rectmp1 == 1) {
                                    if (xx >= 1 && yy >= 1 && xx <= 20 && yy <= 20) {
                                        ...
                                        if (xx <= 20 && yy <= 20 && xx >= 1 && yy >= 1) {
                                            ...
                                            if (vis[xx][yy] == 0) {
                                                cout << "cv1+ Found cv at: " << xx << " " << yy << endl;
...
int main() {
    ...
    cout << "This is Beta V.2.1.2" << endl;
    for (int i = 1; i <= 20; i++) {
        for (int j = 1; j <= 20; j++) {
            map[i][j] = "+";
        }
