...
int px,py;
int vis[CB1][CB1];
int DECouldvis[CB1][CB1];
int DECouldvis1[CB1][CB1];
int tmpi = 0;
int MAINMODE;
int tmpii = 0;
int rectmp = 0;
                        ...
                        if (x11 >= 1 && y11 >= 1 && x11 <= CB && y11 <= CB) {
                            ...
                            if (x11 > 0 && y11 > 0 && x11 <= CB && y11 <= CB && vis[x11][y11] == 0) {
                                if(cnt1 >= MIN_LENGTH){
                                    ...
                                    if(cnt1 == 3){
                                        DECouldvis[x11][y11] = 1;
                                    }
                                    if(cnt1 == 2){
                                        DECouldvis1[x11][y11] = 1;
                                    }
                                    break;
                                }
                            }
            ...
            if (xx1 >= 1 && yy1 >= 1 && xx1 <= CB && yy1 <= CB) {
                if (xx1 > 0 && yy1 > 0 && xx1 <= CB && yy1 <= CB && vis[xx1][yy1] == 0) {
                    if(cnt >= MIN_LENGTH){
                        ...
                        if(cnt == 3){
                            DECouldvis[xx1][yy1] = 1;
                        }
                        if(cnt == 2){
                            DECouldvis1[xx1][yy1] = 1;
                        }
                        break;
                    }
                }
                            ...
                            if(xxx >= 1 && yyy >= 1 && xxx <= CB && yyy <= CB){
                                ...
                                if(vis[xxx][yyy] == 0){
                                    if(cnt21 >= MIN_LENGTH){
                                        ...
                                        if(cnt21 == 3){
                                            DECouldvis[xxx][yyy] = 1;
                                        }
                                        if(cnt21 == 2){
                                            DECouldvis1[xxx][yyy] = 1;
                                        }
                                        flag = true;
                                        cnt21 = 0;
                                        break;
...
int main() {
    //h117ND
    reset();
    cout << "This is Beta V.2.3.3.1" << endl;
    int cnt1 = 0, cnt2 = 0;
    for (int i = 0; i <= CB; i++) {
