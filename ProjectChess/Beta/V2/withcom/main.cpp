                ...
                if (xx > 0 && yy > 0 && xx <= 20 && yy <= 20 && vis[xx][yy] == 1) {
                    ...
                    while (true) {
                        if (x11 >= 1 && y11 >= 1 && x11 <= 20 && y11 <= 20) {
                            ...
                            if (x11 > 0 && y11 > 0 && x11 <= 20 && y11 <= 20 && vis[x11][y11] == 2) {
                                cnt1++;
                                cout << "2 -1 cnt added" << endl;
                                x11 = x11 - dx[dway];
                                y11 = y11 - dy[dway];
                                cout << "2 -1 x11: " << x11 << endl;
                                cout << "2 -1 y11: " << y11 << endl;
                                continue;
                            }
                            if (x11 > 0 && y11 > 0 && x11 <= 20 && y11 <= 20 && vis[x11][y11] == 0) {
                                if(cnt1 >= MIN_LENGTH){
                                    cout << "defend rect2/1 -1 s" << endl;
                                    vis[x11][y11] = 1;
                                    map[x11][y11] = "1";
                                    usedx = x11;
                                    usedy = y11;
                    ...
                    while (true) {
                        if (x11 >= 1 && y11 >= 1 && x11 <= 20 && y11 <= 20) {
                            ...
                            if (x11 > 0 && y11 > 0 && x11 <= 20 && y11 <= 20 && vis[x11][y11] == 2) {
                                ...
                                x11 = x11 + dx[dway];
                                y11 = y11 + dy[dway];
                                cout << "3 -1 cnt added" << endl;
                                cout << "3 -1 x11: " << x11 << endl;
                                cout << "3 -1 y11: " << y11 << endl;
                                continue;
                            }
                            if (x11 > 0 && y11 > 0 && x11 <= 20 && y11 <= 20 && vis[x11][y11] == 0) {
                                if(cnt1 >= MIN_LENGTH){
                ...
                if(xx >= 1 && yy >= 1 && xx <= 20 && yy <= 20){
                    ...
                    if(vis[xx][yy] != 2){
                        ...
                        for(int i2 = 0; i2<=6; i2++){
                            xxx -= dx[i];
                            yyy -= dy[i];
                            cout << "New xxx: " << xxx << endl;
                            cout << "New yyy: " << yyy << endl;
                            if(xxx >= 1 && yyy >= 1 && xxx <= 20 && yyy <= 20){
                                if(vis[xxx][yyy] == 2){
                                    cnt21++;
...
void run(int x, int y){
    cout << "in defend 3" << endl;
    defend(px,py,3);
    if(finished){
        finished = false;
        cout << "defend 3 succeed" << endl;
        return;
    }
    cout << "in attack" << endl;
    attack(x,y);
